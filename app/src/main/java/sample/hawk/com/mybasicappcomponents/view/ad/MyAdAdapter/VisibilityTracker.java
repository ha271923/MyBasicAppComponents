...
class VisibilityTracker {
    ...
    @Nullable OnPreDrawListener mOnPreDrawListener;
    @NonNull final WeakReference<View> mRootView;
    ...
    VisibilityTracker(@NonNull final Activity activity,
        ...
        if (!viewTreeObserver.isAlive()) {
            SMLog.i("Visibility Tracker was unable to track views because the"

package sample.hawk.com.mybasicappcomponents.graphic.PresentationVirtualDisplay;
...
public class MyPresentationVirtualDisplayActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_presentation_virtualdisplay);
        ...
        mButtonPlayVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mMediaPlayer == null) {
                    ...
                    mMediaPlayer = MediaPlayer.create(MyPresentationVirtualDisplayActivity.this, uri, mSurfaceView.getHolder());
                } else {
                    try {
    ...
    private void startScreenCapture() {
        if (mProjection != null) {
            // start virtual displaymDisplayListener
        ...
        public void onDisplayChanged(int i) {
            ...
            if (mCurrentDisplayId == i) {
                if (mNewDisplayAdded) {
                    ...
                    mPresentation = new DemoPresentation(MyPresentationVirtualDisplayActivity.this, display);
                    mPresentation.show();
                }
            }
        }

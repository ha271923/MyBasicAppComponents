package sample.hawk.com.mybasicappcomponents.ad.MoPub;
...
public class NativeListViewFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater,
        ...
        final View view = inflater.inflate(R.layout.mopub_native_list_view_fragment, container, false);
        ...
        final MoPubVideoNativeAdRenderer videoAdRenderer = new MoPubVideoNativeAdRenderer(
                new MediaViewBinder.Builder(R.layout.mopub_video_ad_list_item)
                        .titleId(R.id.native_title)
                        .textId(R.id.native_text)
                        .mediaLayoutId(R.id.mopub_native_media_layout)
                        .iconImageId(R.id.native_icon_image)
                        .callToActionId(R.id.native_cta)
                        .privacyInformationIconImageId(R.id.native_privacy_information_icon_image)
                        .build());

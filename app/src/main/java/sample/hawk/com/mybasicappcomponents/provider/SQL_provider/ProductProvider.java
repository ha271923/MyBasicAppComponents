...
public class ProductProvider extends ContentProvider {
    ...
    public ProductProvider() {
        ...
        mUriMatcher.addURI(SQL_provider_Loader_Activity.AUTHORITY, ProductTable.TABLE_NAME, MAIN);
        mUriMatcher.addURI(SQL_provider_Loader_Activity.AUTHORITY, ProductTable.TABLE_NAME + "/#", MAIN_ID);

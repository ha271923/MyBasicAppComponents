...
public class ExoPlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.exoplayeractivity);
    ...
    private void initializePlayer() {
        ...
        if (player == null) {
            ...
            trackSelectionHelper = new ExoPlayerTrackSelectionHelper(trackSelector, videoTrackSelectionFactory);

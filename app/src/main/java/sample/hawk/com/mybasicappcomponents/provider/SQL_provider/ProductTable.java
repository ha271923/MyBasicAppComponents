...
public final class ProductTable implements BaseColumns {
     ...
     */
    public static final Uri CONTENT_URI =  Uri.parse("content://" + SQL_provider_Loader_Activity.AUTHORITY + "/"+TABLE_NAME);
    ...
    public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse("content://" + SQL_provider_Loader_Activity.AUTHORITY + "/"+TABLE_NAME+"/");

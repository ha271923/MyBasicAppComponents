...
public class DictionaryProvider extends ContentProvider {
     ...
     * When requesting a specific dict_worddetail_activity, the uri alone is required.
    ...
    private Cursor refreshShortcut(Uri uri) {
       ...
       * dict_worddetail_activity, using the given item Uri and provide all the columns originally provided with the
       * suggestion query.
       */
        String rowId = uri.getLastPathSegment();
        String[] columns = new String[] {

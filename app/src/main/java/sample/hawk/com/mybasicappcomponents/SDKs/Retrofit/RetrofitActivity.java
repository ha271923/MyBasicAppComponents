...
import sample.hawk.com.mybasicappcomponents.SDKs.Retrofit.Answer;
import sample.hawk.com.mybasicappcomponents.SDKs.Retrofit.ListWrapper;
import sample.hawk.com.mybasicappcomponents.SDKs.Retrofit.Question;
import sample.hawk.com.mybasicappcomponents.SDKs.Retrofit.RecyclerViewAdapter;
import sample.hawk.com.mybasicappcomponents.SDKs.Retrofit.StackOverflowAPI;
    ...
    Callback<ListWrapper<Question>> questionsCallback = new Callback<ListWrapper<Question>>() {
        ...
        public void onResponse(Call<ListWrapper<Question>> call, Response<ListWrapper<Question>> response) {
            if (response.isSuccessful()) {
                ...
                ArrayAdapter<Question> arrayAdapter = new ArrayAdapter<Question>(RetrofitActivity.this, android.R.layout.simple_spinner_dropdown_item, questions.items);

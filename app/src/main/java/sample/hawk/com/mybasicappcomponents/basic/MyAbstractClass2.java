 ...
 */
// Abstrace class 可以繼承 Abstract class
public abstract class MyAbstractClass2 extends MyAbstractClass implements MyInterface, MyInterface2 { // JAVA: you can't new a abstract class obj directly.

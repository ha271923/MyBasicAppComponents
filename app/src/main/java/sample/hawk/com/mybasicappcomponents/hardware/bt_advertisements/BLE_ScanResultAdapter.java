...
/**
 * Holds and displays {@link ScanResult}s, used by {@link BLE_ScannerFragment}.
 */
public class BLE_ScanResultAdapter extends BaseAdapter {
    ...
    BLE_ScanResultAdapter(Context context, LayoutInflater inflater) {
        super();
        mContext = context;
        mInflater = inflater;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(R.layout.bt_advertisement_listitem_scanresult, null);
        }

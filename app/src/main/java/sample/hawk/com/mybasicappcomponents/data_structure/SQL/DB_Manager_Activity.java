...
/**
 為了Debug Android SQL database, 這個範例提供一個通用列表視覺化的顯示,
 只需要針對所需要Debug的DB定義 SQLiteOpenHelper(EX: DB_Manager_Helper.java)
 , 這樣就會顯示該DB的資料清單內容

 Reference at https://github.com/sanathp/DatabaseManager_For_Android/blob/master/AndroidDatabaseManager.java

 Introduce at https://github.com/sanathp/DatabaseManager_For_Android

 */
public class DB_Manager_Activity extends Activity implements OnItemClickListener {
...
// all global variables
    ...
    //in the below line Change the text 'yourCustomSqlHelper' with your custom sqlitehelper class(Ex:DB_Manager_Helper.java) name.
    //Do not change the variable name dbm
    DB_Manager_Helper dbm;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbm = new DB_Manager_Helper(DB_Manager_Activity.this);

        mainscrollview = new ScrollView(DB_Manager_Activity.this);
        ...
        mainLayout = new LinearLayout(DB_Manager_Activity.this);
        ...
        final Button submitQuery = new Button(DB_Manager_Activity.this);
        ...
        final TextView help = new TextView(DB_Manager_Activity.this);
        ...
        final Spinner spinnertable =new Spinner(DB_Manager_Activity.this);
        ...
        final LinearLayout thirdrow = new LinearLayout(DB_Manager_Activity.this);
        previous = new Button(DB_Manager_Activity.this);
        previous.setText("Previous");

        previous.setBackgroundColor(Color.parseColor("#BAE7F6"));
        previous.setLayoutParams(secondrowlp);
        next = new Button(DB_Manager_Activity.this);
        next.setText("Next");
        ...
        tvmessage =new TextView(DB_Manager_Activity.this);
        ...
        final Button customQuery = new Button(DB_Manager_Activity.this);
        ...
        ArrayAdapter<String> tablenamesadapter = new ArrayAdapter<String>(DB_Manager_Activity.this,
        ...
        select_table.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent,
                ...
                if(pos!=0){
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(DB_Manager_Activity.this,
                    ...
                    if(c2!=null)
                    {
                        ...
                        spinnertable.setOnItemSelectedListener((new AdapterView.OnItemSelectedListener() {
                            ...
                            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            if(!isFinishing()){
                                                ...
                                                new AlertDialog.Builder(DB_Manager_Activity.this)
                                ...
                                if(spinnertable.getSelectedItem().toString().equals("Add row to this table"))
                                {
                                    ...
                                    final ScrollView addrowsv =new ScrollView(DB_Manager_Activity.this);
                                    ...
                                    final RelativeLayout addnewlayout = new RelativeLayout(DB_Manager_Activity.this);
                                    ...
                                    for(int i=0;i<addnewrownames.size();i++)
                                    {
                                        ...
                                        et.setId(k);
                                        final LinearLayout ll = new LinearLayout(DB_Manager_Activity.this);
                        ...
                        {
                            LinearLayout cell = new LinearLayout(DB_Manager_Activity.this);
    ...
    public void updateDeletePopup(int row)
    {
        ...
        final RelativeLayout lp = new RelativeLayout(DB_Manager_Activity.this);
        lp.setBackgroundColor(Color.WHITE);
        RelativeLayout.LayoutParams lay = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
        lay.addRule(RelativeLayout.ALIGN_PARENT_TOP);

        final ScrollView updaterowsv =new ScrollView(DB_Manager_Activity.this);
        LinearLayout lcrud = new LinearLayout(DB_Manager_Activity.this);
        ...
        ArrayAdapter<String> crudadapter = new ArrayAdapter<String>(DB_Manager_Activity.this,

...
public class BluetoothChatService {
    ...
    private synchronized void updateUserInterfaceTitle() {
        mState = getState();
        Logger.d(TAG, "updateUserInterfaceTitle() " + mNewState + " -> " + mState);
        mNewState = mState;
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                try {
                    ...
                    Logger.e(TAG, "Socket Type: " + mSocketType + "accept() failed", e);
                    break;
                }
        ...
        public void cancel() {
            ...
            try {
                ...
                Logger.e(TAG, "Socket Type" + mSocketType + "close() of server failed", e);
            }
        }
    }
    ...
    private class ConnectThread extends Thread {
        ...
        public void cancel() {
            try {
                ...
                Logger.e(TAG, "close() of connect " + mSocketType + " socket failed", e);
            }
        }
    }

 ...
 */
public class ExoPlayerListActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.exoplayer_sample_chooser_activity);
    ...
    if (dataUri != null) {
      ...
      try {
        for (String asset : assetManager.list("")) { // Hawk: Menu will be listed by assets\media.exolist.json file.

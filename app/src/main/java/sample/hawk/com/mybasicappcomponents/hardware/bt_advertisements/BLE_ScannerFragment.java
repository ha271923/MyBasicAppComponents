 ...
 */
public class BLE_ScannerFragment extends ListFragment {

    private static final String TAG = BLE_ScannerFragment.class.getSimpleName();
    ...
    private BLE_ScanResultAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new BLE_ScanResultAdapter(getActivity().getApplicationContext(),
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(R.menu.bt_scanner_menu, menu);
    }
    ...
    private List<ScanFilter> buildScanFilters() {
        ...
        builder.setServiceUuid(BLE_Constants.Service_UUID);

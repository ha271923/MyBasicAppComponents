 ...
 * Bluetooth LE API.
 *
 * It creates a Service for managing connection and data communication with a GATT server hosted
 * on a given Bluetooth LE device.
 *
...
public class BLE_DeviceControlActivity extends Activity {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder service) {
            ...
            if (!mBluetoothLeService.initialize()) {
                SMLog.e(TAG, "Unable to initialize Bluetooth");
                finish();
            }
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BLE_Service.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                displayData(intent.getStringExtra(BLE_Service.EXTRA_DATA));
            }
        }
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.btgatt_gatt_services_characteristics);
        ...
        if(isBTenabled()==false)
            Toast.makeText(this,"Please Enable BT first!", Toast.LENGTH_SHORT).show();
        if(isDeviceSupportBLE()==false)
            Toast.makeText(this,"Your device NOT support BLE...XD", Toast.LENGTH_SHORT).show();
        if(mDeviceName==null)
            mDeviceName = getResources().getString(R.string.unknown_device);
    ...
    protected void onResume() {
        ...
        if (mBluetoothLeService != null) {
            ...
            SMLog.d(TAG, "Connect request result=" + result);
        }
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.btgatt_services, menu);
        if (mConnected) {
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            currentServiceData.put(
                    LIST_NAME, BLE_SampleGattAttributes.lookup(uuid, unknownServiceString));
            ...
            for (BluetoothGattCharacteristic gattCharacteristic : gattCharacteristics) {
                ...
                currentCharaData.put(
                        LIST_NAME, BLE_SampleGattAttributes.lookup(uuid, unknownCharaString));

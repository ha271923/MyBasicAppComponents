 ...
 */
package sample.hawk.com.mybasicappcomponents.view.ExoPlayer;
 ...
 */
/* package */ final class ExoPlayerTrackSelectionHelper implements View.OnClickListener,
   ...
   */
  public ExoPlayerTrackSelectionHelper(MappingTrackSelector selector,
  ...
  private View buildView(Context context) {
    ...
    View view = inflater.inflate(R.layout.exoplayer_track_selection_dialog, null);

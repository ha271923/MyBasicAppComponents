...
JNIEXPORT void JNICALL
    ...
    JNIEXPORT void JNICALL
    Java_sample_hawk_com_mybasicappcomponents_jni_AccelerometerGraphJNI_drawFrame(
    ...
    JNIEXPORT void JNICALL
    Java_sample_hawk_com_mybasicappcomponents_jni_AccelerometerGraphJNI_pause(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.pause();
    ...
    JNIEXPORT void JNICALL
    Java_sample_hawk_com_mybasicappcomponents_jni_AccelerometerGraphJNI_resume(
            JNIEnv *env, jclass type) {
        (void)env;
        (void)type;
        gSensorGraph.resume();

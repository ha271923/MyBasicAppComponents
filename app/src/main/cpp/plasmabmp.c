...
/* Set to 1 to optimize memory stores when generating plasmabmp. */
...
/* Color palette used for rendering the plasmabmp */
...
JNIEXPORT void JNICALL Java_sample_hawk_com_mybasicappcomponents_jni_PlasmaBmp_PlasmaView_renderPlasma(JNIEnv * env, jobject  obj, jobject bitmap,  jlong  time_ms)
{
        ...
        /* Now fill the values with a nice little plasmabmp */

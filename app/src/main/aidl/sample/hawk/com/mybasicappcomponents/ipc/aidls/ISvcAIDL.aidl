...
import sample.hawk.com.mybasicappcomponents.ipc.aidls.IAppAIDL;

// Declare any non-default types here with import statements

// AIDL_1、創建AIDL檔, 在這個檔裡面定義介面, 該介面定義了可供用戶端訪問的方法和屬性。 如: ISvcAIDL.adil
...
interface ISvcAIDL {
    void SvcAPI(int anInt, long aLong, boolean aBoolean, float aFloat, double aDouble, String aString);

    void registerSvc2AppCallback(IAppAIDL cb); // for callback from Service to App
}
